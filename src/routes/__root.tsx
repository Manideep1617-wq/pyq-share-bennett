...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${APP_NAME} — Previous year question papers` },
      {
        name: "description",
        content: `Find, download and share previous year question papers from ${COLLEGE_NAME}.`,
      },
      { property: "og:title", content: `${APP_NAME} — Previous year question papers` },
      {
